...
#### Languages and Tools 
[![My Skills](https://skillicons.dev/icons=vue,ts,sass,redis,react,raspberrypi,py,postman,postgres,php,nodejs,nginx,mysql,linux,jquery,js,java,html,css,bootstrap,heroku,gradle,git,glutter,firebase,docker,django,c,cpp,aws,androidstudio,&perline=3)](https://skillicons.dev)
